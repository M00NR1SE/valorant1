...
public class GameBoard : MonoBehaviour
{
    ...
    public static int livesPlayerOne = 3; 
    ...
    public Text playerText, readyText, highScoreScore, playerOneUp, playerOneScoreText, levelText;
    ...
    IEnumerator ProcessRestart(float delay)
    {
        ...
        if (livesPlayerOne == 0 ) //If total Game over...
        {
        ...
        else if (!GameMenu.isOnePlayerGame && (livesPlayerOne == 0)) //If game over for only 1 player
        {
            if (livesPlayerOne == 0)
            {
